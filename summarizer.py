...
def generate_summary_from_bedrock(content:str) ->str:
    prompt_text = f"""Human: Summarize the following short story: {content}
    Assistant:"""
...
def save_summary_to_s3_bucket(summary, s3_bucket, s3_key):
    ...
    try:
        ...
        print("Error when saving the summary to the S3 bucket.")
...
def lambda_handler(event,context):
    ...
    if summary:
        ...
        print("Sorry, no summary was generated.")


    return {
        'statusCode':200,
        'body':json.dumps("Summary generation completed!")
    }
